...
<p>
	...
	<a href="{{ route('audio.create', array( 'recording' => $recording->recording_id ) ) }}" class="button"><span class="glyphicon glyphicon-plus"></span> Add audio file</a>
	@else
	<a href="{{ route('audio.create') }}" class="button"><span class="glyphicon glyphicon-plus"></span> Add audio file</a>
	@endif
</p>
